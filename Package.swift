...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/skelpo/APIErrorMiddleware.git", from: "0.3.3")

    ],
    targets: [
        .target(name: "App", dependencies: ["Vapor", "SwiftyJSON", "Authentication", "SendGrid", "Pagination", "FluentPostgreSQL", "APIErrorMiddleware"]),
